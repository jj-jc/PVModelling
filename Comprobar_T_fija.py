...
plt.plot(filt_df2['aoi'],y_physical,'o',markersize=2,label='funcion_physical')
plt.plot(filt_df2['aoi'],y_ashrae,'o',markersize=2,label='ashrae')
plt.plot(filt_df2['aoi'],y_martin_ruiz,'o',markersize=2,label='Martin')
plt.xlabel('Ángulo de incidencia (°)')
plt.ylabel('IAM')
plt.title("Regresiones de diferentes funciones para el coeficiente de utilización en función del ángulo de incidencia",fontsize=20)
#plt.text(12, 0.35,'El coeficiente de determinación para ashrae es:  ' + str(RR_ashrae)[:str(RR_ashrae).find(".")+5], fontsize=15)
...
#-----------------fitting con los datos de normalizacion de ISC/DII------------
RR_ashrae,b=IAM_ashrae.regresion_ashrae(filt_df2['aoi'],filt_df2['IAM_aoi_'])
RR_physical,n,k,l =IAM_pysical_bruto.regresion_pysical(filt_df2['aoi'],filt_df2['IAM_aoi_'])
RR_martin_ruiz,a_r=IAM_Martin.regresion_martin_ruiz(filt_df2['aoi'],filt_df2['IAM_aoi_'])
...
plt.plot(filt_df2['aoi'],y_ashrae,'o',markersize=2,label='regresión por ashrae')
plt.plot(filt_df2['aoi'],y_pysical,'o',markersize=2,label='regresión por pysical')
plt.plot(filt_df2['aoi'],y_martin_ruiz,'o',markersize=2,label='regresión por martin_ruiz')
plt.xlabel('Ángulo de incidencia (°)')
plt.ylabel('IAM')
#    plt.text(12, 0.4,'Temperaturas entre: '+ str(lim_inf)[:str(lim_inf).find(".")]+ '°C y '+ str(lim_sup)[:str(lim_sup).find(".")]+'°C', fontsize=15)
#    plt.text(12, 0.35,'El coeficiente de determinación para ashrae es:  ' + str(RR_ashrae)[:str(RR_ashrae).find(".")+5], fontsize=15)
