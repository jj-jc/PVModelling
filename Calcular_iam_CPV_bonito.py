...
plt.ylim(0,0.0015 )
plt.plot(filt_df2['aoi'],filt_df2['ISC_IIIV/DII (A m2/W)'], 'o',markersize='4',label='Sin filtrado')    
plt.plot(filt_cuadro2['aoi'],filt_cuadro2['ISC_IIIV/DII (A m2/W)'],'o', markersize='2',label='Con filtrado')    
...
plt.xlabel('Ángulo de incidencia (°)',fontsize=20)
plt.ylabel('ISC_IIIV/DII (A m2/W)',fontsize=20)
plt.title('Regresiones polinómicas',fontsize=30 )
plt.legend() 
...
plt.title('Regresiones polinómicas')
plt.legend() 
