...
color_.set_label('Temperatura ambiente (ºC)',fontsize=15)
color_.ax.tick_params(labelsize=15) 
plt.show()
...
color_.set_label('Ángulo de incidencia (º)',fontsize=15)
color_.ax.tick_params(labelsize=15) 
plt.show()
...
color_.set_label('Velocidad del viento (m/s)',fontsize=20)
color_.ax.tick_params(labelsize=15) 
plt.show()
...
color_.set_label('Dirección del viento (ºN)',fontsize=20 )
color_.ax.tick_params(labelsize=15) 
plt.show()
