...
plt.ylabel('ISC_Si/Irra_vista (A m2/W)',fontsize=30)
...
plt.yticks(fontsize=30)
plt.legend(fontsize=30)
plt.title("Datos de eficiencia de captación en función de la temperatura",fontsize=40)
...
plt.yticks(fontsize=30)
plt.legend(fontsize=30)
plt.title("Datos de eficiencia de captación en función del ángulo del airmass",fontsize=40)
...
plt.xlabel('Ángulo de incidencia (º)',fontsize=30)
plt.ylabel('Potencia Si (W)',fontsize=30)
plt.xticks(fontsize=30)
plt.yticks(fontsize=30)
plt.legend(fontsize=30)
plt.title("Datos de potencia en función del ángulo de incidencia",fontsize=40)
...
ax.set_ylabel('ISC_Si/Irradiancia vista por el silicio (A m2/W)',fontsize=30)
ax.set_title("Eficiencia de captación del silicio en función del ángulo de incidencia y la temperatura",fontsize=40)
color_=fig.colorbar(Mappable_Temp)
color_.set_label('Temperatura ambiente (ºC)')
...
ax.set_ylabel('ISC_Si/Irradiancia vista por el silicio (A m2/W)',fontsize=30)
ax.set_title("Eficiencia de instensidad del silicio en función de la masa de aire y la temperatura",fontsize=40)
color_=fig.colorbar(Mappable_Temp)
...
#plt.ylim(0,0.0012)
#plt.xlim(1,2)
ax.set_xlabel('Temperatura',fontsize=30)
ax.set_ylabel('ISC_Si/Irradiancia vista por el silicio (A m2/W)',fontsize=30)
ax.set_title("Eficiencia de instensidad del silicio en función de la temperatura y el ángulo de incidencia",fontsize=40)
plt.xticks(fontsize=30)
plt.yticks(fontsize=30)
plt.legend(fontsize=30)
color_=fig.colorbar(Mappable_aoi)
...
#plt.xlim(10,60)
ax.set_xlabel('Ángulo de incidencia (º)',fontsize=30)
ax.set_ylabel('ISC_Si/Irradiancia vista por la célula (A m2/W)',fontsize=30)
ax.set_title("Eficiencia de instensidad del silicio en función del ángulo de incidencia y la temperatura",fontsize=40)
plt.xticks(fontsize=30)
plt.yticks(fontsize=30)
plt.legend(fontsize=30)
color_=fig.colorbar(Mappable_Temp)
