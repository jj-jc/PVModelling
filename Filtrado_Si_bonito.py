...
fig=plt.figure(figsize=(30,15))
plt.ylim(0,0.04)
plt.plot(filt_df_['T_Amb (°C)'],filt_df_['ISC_Si/Irra_vista (A m2/W)'], 'o',markersize='4',label='Sin filtrado')    
plt.plot(filt_df['T_Amb (°C)'],filt_df['ISC_Si/Irra_vista (A m2/W)'],'o', markersize='2',label='Con filtrado')    
