...
plt.ylabel('Potencia estimada (W)',fontsize=20)
plt.title("Comparativa de potencias estimadas del III-V con el Silicio en función del tiempo",fontsize=30)
plt.legend()
...
plt.xlabel('Tiempo',fontsize=20)
plt.ylabel('Intensidad medida (A)',fontsize=20)
plt.title("Comparativa de intensidades del III-V con el Silicio en función del tiempo de todos los datos", fontsize=30)
plt.legend()
...
plt.xlabel('Tiempo',fontsize=20)
plt.ylabel('Potencia estimada (W)',fontsize=20)
plt.title("Comparativa de potencias estimadas del III-V con el Silicio en función del ángulo de incidencia",fontsize=30)
plt.legend()

plt.figure(figsize=(30,20))
host = host_subplot(111)
par = host.twinx()
host.set_xlabel("Ángulo de incidencia (º)",fontsize=20)
host.set_ylabel("Eficiencia de la captación de irradiancia del IIIV(A m2/W)",fontsize=20)
par.set_ylabel("Eficiencia de la captación de irradiancia del Silicio(A m2/W)",fontsize=20)
...
plt.title("Comparativa de eficiencia de intensidad III-V con el Silicio en función del ángulo de incidencia", fontsize=30)
plt.show()
