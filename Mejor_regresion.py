...
plt.plot(x,y_excel,'--',markersize=2,label='Regresión excel (segundo grado)')
...
plt.text(2, 0.6,'El coeficiente de determinación de la regresión de segundo grado es: ' + str(E.Determination_coefficient(y_datos,y_excel)), fontsize=15)
